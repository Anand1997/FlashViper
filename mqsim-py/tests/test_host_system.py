...
def test_host_system_initialization():
    ...
    # def __init__(self, id, stream_id, read_ratio, start_lsa, end_lsa, seed, queue_depth=1, host_interface=None):
    flow = SyntheticIOFlow(id="flow1", stream_id=0, read_ratio=0.5, start_lsa=0, end_lsa=1000, seed=42)
